...
import com.esafirm.imagepicker.helper.LocaleManager.setLanguage
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cameraView.addFrameProcessor{ frame ->
            ...
            if (frame.dataClass === ByteArray::class.java){
                ...
                Toast.makeText(this, "카메라없음", Toast.LENGTH_LONG).show()
            }
        }
    }
        ...
        for (i in 0 until faces.size()) {
            ...
            if (with > without){
              ...
              // vibrator.vibrate(vibrationEffect)
               ...
               // tts.speak("마스크착용해주세요",TextToSpeech.QUEUE_ADD, null, null )
